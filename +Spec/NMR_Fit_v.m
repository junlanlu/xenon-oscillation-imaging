...
%             end
        ...
        function describe_ppm(obj,xeGam)
            % This function will report on the fitted component
            ...
            disp('area (arbs)  Freq (Hz)  Linewidth(Hz)  Phase(degrees)');
            for iComp = 1:nComp
                disp([sprintf('%8.2f',obj.area(iComp)/obj.area(nComp)) ' ' ...
                    sprintf('%+8.2f',(obj.freq(iComp)-obj.freq(nComp))/xeGam)  '  ' ...
                    sprintf('%8.2f',(obj.fwhm(iComp)-obj.lineBroadening)/xeGam) '  ' ...
                    sprintf('%8.2f',(obj.fwhmG(iComp)-obj.lineBroadening)/xeGam) '  ' ...
                    sprintf('%+9.2f',obj.phase(iComp))]);
            end
        end
    end
